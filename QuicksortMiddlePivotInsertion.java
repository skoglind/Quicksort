/**
 * QuicksortMiddlePivotInsertion - Sorteringsalgoritm.
 * @author Fredrik Skoglind
 */
public class QuicksortMiddlePivotInsertion implements IntSorter {
    private Helpers h;
    private InsertionSort iSort;
    private int cutoff = 9;

    public QuicksortMiddlePivotInsertion() {
        h = new Helpers();
    ...
    private void qs(int[] v, int first, int last) {
        if( (last-first) <= cutoff ) {
            ...
            int pivot = h.middlePivot(v, first, last);
